...
Installation
============
## Install option 1 (for installing the pySuStaIn code in a chosen directory): 
## clone repository, install locally
...
## Install option 2 (for using pySuStaIn as a package): 
